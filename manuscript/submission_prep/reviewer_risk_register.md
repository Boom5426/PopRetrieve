...
| 5 | "Why does EvalShift fail on predicted responses?" | med | Result 4 | Mechanism: predictors collapse structure (~5x lower subpop-variance ratio); no structure to exploit — the thesis, not a defect. |
