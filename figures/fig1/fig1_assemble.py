"""EvalShift Figure 1: Distributional differences are visible, but their value depends on the evaluator.
...
# missing: the manuscript states "We report EvalShift under all three classes", with the Class-C
