...
| f | "All five EvalShift metrics gain under the Class-A metric" | fig3f_classA_robustness.csv | done |
...
- 3f: all five EvalShift metrics positive on the 621 gate-recommended queries: energy +0.056, MMD +0.060,
