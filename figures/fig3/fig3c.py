"""JUDGE Figure 3 panel 3c: per-query regret reduction, ECDF over ALL 765 queries.
...
def regret_reduction():
    """Paired per-query regret reduction, mean-cosine minus JUDGE coverage-worst, all queries."""
