...
SINCE 2026-08-30 draw_ed6b, draw_ed6c and draw_ed6d are main-text Fig. 4g, 4h and 4i, drawn by
fig4/fig4_assemble.py, directly under the HIR-Bench boundary and leakage test in Fig. 4a,b that
they verify. draw_ed6a, the generative-model schematic, is deleted: it drew no data and Fig. 4a
plus Supplementary Note 1 already carry it.
