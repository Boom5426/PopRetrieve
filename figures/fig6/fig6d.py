"""DART Figure 6 panel 6d: multi-dimensional structure diagnostics, predicted relative to real.
...
def draw_6d(ax):
    ...
    for (yy, v) in rows:
        ax.plot([1.0, v], [yy, yy], lw=1.0, color=FOCAL, alpha=0.55, zorder=3)
        ax.plot([v], [yy], "o", ms=4.4, color=FOCAL, mec="white", mew=0.5, zorder=4)
...
if __name__ == "__main__":
    fig, ax = plt.subplots(figsize=(1.85, 1.62))   # the slot it occupies in fig6_assemble
    draw_6d(ax)
