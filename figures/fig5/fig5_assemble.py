...
7-panel two-gate mechanism figure. Assembles a-g into fig5_two_gate.{png,pdf}.
...
FIG_W, FIG_H = 6.90, 5.14          # inches; the manuscript text block is 6.93 x 9.43 in
# 5.14 in, not 5.60: the 0.22-0.32 in reserved above each row for a panel title is no longer
# needed. Titles are not drawn (see strip_titles at the end of build); the rows keep their
# heights and move up, and the canvas loses the 0.46 in the three title bands occupied.
...
BOXES = {
    ...
    "a": (0.62, 3.56, 1.33, 1.42),
    "b": (2.57, 3.56, 1.43, 1.42),
    "c": (4.50, 3.56, 1.88, 1.42),
    "d": (0.62, 1.94, 1.85, 1.32),
    "e": (2.99, 1.94, 3.63, 1.32),
...
def build(apply_style, panel_letter):
    ...
    # Nature panels carry no titles; the seven claims in TITLES are the caption's seven entries.
