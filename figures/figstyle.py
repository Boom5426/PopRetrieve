"""DART Nature-Methods house style, shared across all figure panels.
...
Palette (one edit here recolours the whole deck):
  FOCAL  = #5185C0  distributional / DART / structure-preserved   (blue)
...
FOCAL = "#5185C0"      # distributional / DART
...
GREEN = "#55966B"
INK = "#1A1A1A"
# signed DART-minus-mean advantage: orange (mean) <- white -> blue (DART)
