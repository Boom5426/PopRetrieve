...
WHY THE QUESTION ARISES. exp13 records, per task, the minority-state coverage of the EvalShift
...
untrustworthy on this data:
  ...
  1. The threshold is not calibrated to the data. It sits at 0.77 standard deviations of the
     ...
     one-sided: on the FULL run 11 tasks clear it for EvalShift and 2 clear it for the mean.
