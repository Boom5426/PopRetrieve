"""Path resolution + small IO helpers for the JUDGE repo.

JUDGE is a standalone repository; the package root IS the repo root. Processed tensors
...
PKG_ROOT = Path(__file__).resolve().parents[2]          # JUDGE/  (repo root == package root)
