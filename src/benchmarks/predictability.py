...
whether a PopRetrieve-style distributional method would improve over mean retrieval.
...
def score_disagreement(mean_scores: np.ndarray, dist_scores: np.ndarray) -> float:
    ...
    Higher = the two scoring paradigms disagree more = PopRetrieve may help.
    """
