...
match — so pairing it with EvalShift's distributional decision layer cannot manufacture
subpopulation coverage the predictor never modeled. That is the point: exp09 shows the
*predictor* is the ceiling for a mean+R² retrieval, and EvalShift's gains over a mean retrieval
