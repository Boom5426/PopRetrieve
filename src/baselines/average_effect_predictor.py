...
match — so pairing it with PopRetrieve's distributional decision layer cannot manufacture
subpopulation coverage the predictor never modeled. That is the point: exp09 shows the
*predictor* is the ceiling for a mean+R² retrieval, and PopRetrieve's gains over a mean retrieval
