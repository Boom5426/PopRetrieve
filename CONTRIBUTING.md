# Contributing to PopRetrieve

Thanks for your interest. PopRetrieve is a research codebase accompanying a methods
...
- **Every reported number must stay reproducible.** If you touch a scorer,
  ...
  tolerance).
- **Be honest about negatives.** PopRetrieve is framed as a *probe*, not a universally
...
3. **Keep diffs focused.** One logical change per PR. Do not commit large data
   ...
   un-ignored and tracked, because Fig. 2c is a per-query ECDF over exactly those rows and a
