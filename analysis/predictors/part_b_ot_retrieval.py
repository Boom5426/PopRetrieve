...
def main():
    ...
    print("If opening Gate 1 helps, the PopRetrieve-minus-mean delta is larger for ot_map than additive.")
    ...
    # the decisive contrast: is the PopRetrieve advantage LARGER for the Gate-1-opening predictor?
    if "ot_map" in res and "average_effect" in res:
        print("\nDOES OPENING GATE 1 HELP? PopRetrieve-minus-mean advantage, ot_map versus additive:")
        res["contrast"] = {}
        for metric in ["hit@1", "ndcg@10"]:
