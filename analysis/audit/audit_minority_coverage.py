...
def main():
    ...
    for seed in range(N_SEEDS):
        ...
        if dart_top1 != mean_sel_top1:
            ...
            print(f"  DART selects: {dart_top1}, mean_cosine selects: {mean_sel_top1}")
            print(f"    DART-sel  cell_cov={cell_covs[dart_top1]:.4f}  mean_cov={mean_covs[dart_top1]:.4f}")
            print(f"    Mean-sel  cell_cov={cell_covs[mean_sel_top1]:.4f}  mean_cov={mean_covs[mean_sel_top1]:.4f}")
        else:
            print(f"  DART and mean_cosine agree: {dart_top1}")
    ...
    print(f"  DART wins cell-level: {dart_wins_cell_total}/{total_queries} = {dart_cell_frac:.4f}")
    print(f"  DART wins mean-based: {dart_wins_mean_total}/{total_queries} = {dart_mean_frac:.4f}")
