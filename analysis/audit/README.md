...
Each script tests one candidate objection to JUDGE's oracle-independent null. All
...
- `fix_validation_e2e.py`, end-to-end validation that the cell-level coverage fix does not rescue JUDGE (wins only 36.7%, p=0.99).
