...
- `signal_decode_run.py`, decodes what DART's real (non-circular) signal encodes by
  comparing DART-vs-mean drug picks against structural/target/MoA properties. The
